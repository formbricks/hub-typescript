...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      "typescript": {
        ...
        "example": "import FormbricksHub from '@formbricks/hub';\n\nconst client = new FormbricksHub();\n\nconst response = await client.health.check();\n\nconsole.log(response);"
      },
      "http": {
  ...
  },
  {
    ...
    "response": "{ data: { id: string; collected_at: string; created_at: string; field_id: string; field_type: 'text' | 'categorical' | 'nps' | 'csat' | 'ces' | 'rating' | 'number' | 'boolean' | 'date'; source_type: string; submission_id: string; tenant_id: string; updated_at: string; field_group_id?: string; field_group_label?: string; field_label?: string; language?: string; metadata?: object; source_id?: string; source_name?: string; user_id?: string; value_boolean?: boolean; value_date?: string; value_number?: number; value_text?: string; }[]; limit: number; next_cursor?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:8080/v1/feedback-records \\\n    -H \"Authorization: Bearer $HUB_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; collected_at: string; created_at: string; field_id: string; field_type: 'text' | 'categorical' | 'nps' | 'csat' | 'ces' | 'rating' | 'number' | 'boolean' | 'date'; source_type: string; submission_id: string; tenant_id: string; updated_at: string; field_group_id?: string; field_group_label?: string; field_label?: string; language?: string; metadata?: object; source_id?: string; source_name?: string; user_id?: string; value_boolean?: boolean; value_date?: string; value_number?: number; value_text?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:8080/v1/feedback-records/$ID \\\n    -H \"Authorization: Bearer $HUB_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:8080/v1/feedback-records/$ID/similar \\\n    -H \"Authorization: Bearer $HUB_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Embeds the search query and returns feedback record IDs with similarity scores (cosine, 0..1).\n**Only available when embeddings are configured** (EMBEDDING_PROVIDER and EMBEDDING_MODEL set).\nSupported providers: openai, google (AI Studio), google-vertex.\nWhen embeddings are disabled, this endpoint returns 503 Service Unavailable.\nRequest body must include query and tenant_id (required for tenant isolation).\n",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:8080/v1/feedback-records/search/semantic \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HUB_API_KEY\" \\\n    -d '{\n          \"query\": \"What do users think about login speed?\",\n          \"tenant_id\": \"org-123\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ data: { id: string; created_at: string; enabled: boolean; updated_at: string; url: string; disabled_at?: string; disabled_reason?: string; event_types?: string[]; tenant_id?: string; }[]; limit: number; next_cursor?: string; offset?: number; total?: number; }",
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; enabled: boolean; signing_key: string; updated_at: string; url: string; disabled_at?: string; disabled_reason?: string; event_types?: string[]; tenant_id?: string; }",
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; enabled: boolean; updated_at: string; url: string; disabled_at?: string; disabled_reason?: string; event_types?: string[]; tenant_id?: string; }",
