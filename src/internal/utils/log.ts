...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: FormbricksHub): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: FormbricksHub): Logger {
